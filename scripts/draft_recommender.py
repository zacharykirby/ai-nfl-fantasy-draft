...
class DraftRecommender:
    ...
    def __init__(self, ollama_url: str = None, model: str = "gemma3"):
        # Use OLLAMA_HOST environment variable or default to network address
        if ollama_url is None:
            import os
            ollama_host = os.getenv('OLLAMA_HOST', '192.168.0.128')
...
def main():
    ...
    parser.add_argument('--ollama-url', type=str, default=None,
                       help='Ollama API URL (default: uses OLLAMA_HOST env var or 192.168.0.128)')
